<?php
/**
 * FoundBreadcrumbs class file. Replaces CBreadcrumbs, Extends CWidget
 * for use with Foundation 4 theme
 *
 ...
 * 
 * Revised 2014-01-05, Gary Parker <gary.parker@gmail.com>
 */

/**
 * FoundBreadcrumbs displays a list of links indicating the position of the current page in the whole website.
 *
 * For example, breadcrumbs like "Home > Sample Post > Edit" means the user is viewing an edit page
 * for the "Sample Post". He can click on "Sample Post" to view that page, or he can click on "Home"
 * to return to the homepage.
 *
 * To use FoundBreadcrumbs, one usually needs to configure its {@link links} property, which specifies
 * the links to be displayed. For example,
 *
 * <pre>
 * $this->widget('application.extentions.Breadcrumbs', array(
 *     'links'=>array(
 ...
 *
 * <pre>
 * $this->widget('application.extensions.Breadcrumbs', array(
 ...
 * @since 1.1
 */
class FoundBreadcrumbs extends CWidget
{
	/**
	 * @var string the tag name for the breadcrumbs container tag. . 
	 * Formerly defaulted to 'div', now to 'ul'.
	 * Gary Parker 2014-01-05
	 */
	public $tagName='ul';
	/**
	...
	public $homeLinkTemplate='<li><a href="{url}">{label}</a></li>';
	/**
	 ...
	 * Gary Parker 2014-01-05
	 */
	public $inactiveLinkTemplate='<li class="current"><a href="#">{label}</a></li>';
	/**
	...
	public function run()
	{
		...
		// editted by gary	$links[]=CHtml::link(Yii::t('zii','Home'),Yii::app()->homeUrl);
		
		$links[]=strtr($this->homeLinkTemplate,
			array(
					'{url}'=>Yii::app()->homeUrl,
